...
def update_clockcor(version, file,
    ...
    from heasarc.pycaldb.pycaldb import *
    ...
    fname = nucaldb.html_summar(missonurl='https://www.nustar.caltech.edu',outdir=outdir, templatedir=templatedir, clobber=True)
